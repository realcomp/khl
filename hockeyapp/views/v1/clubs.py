...
class ClubListView(TemplateView):
    template_name = 'hockeyapp/v1/clubs/clubs.html'
...
class ClubView(SeasonsMixin, DetailView):
    model = Club
    template_name = 'hockeyapp/v1/clubs/clubs-team.html'
...
class ClubView2(TemplateView):
    template_name = 'hockeyapp/v1/clubs/clubs-team2.html'


class ClubCalendarView(ClubView):
    template_name = 'hockeyapp/v1/clubs/clubs-calendar.html'


class ClubHomeView(ClubView):
    template_name = 'hockeyapp/v1/clubs/clubs-home.html'


class ClubFanZoneView(ClubView):
    template_name = 'hockeyapp/v1/clubs/clubs-fan.html'


class ClubPhotosView(ClubView):
    template_name = 'hockeyapp/v1/clubs/clubs-photos.html'


class ClubStatsView(ClubView):
    template_name = 'hockeyapp/v1/clubs/clubs-stats.html'
...
class ClubNewsView(ClubView):
    template_name = 'hockeyapp/v1/clubs/clubs-news.html'


class ClubNumbersView(ClubView):
    template_name = 'hockeyapp/v1/clubs/clubs-numbers.html'
