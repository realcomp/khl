...
class PlayersSearch(TemplateView):
    template_name = 'hockeyapp/v1/players/players-search.html'
...
class PlayersSearch2(PlayersSearch):
    template_name = 'hockeyapp/v1/players/players-search2.html'


class PlayerCard(DetailView):
    model = Player
    template_name = 'hockeyapp/v1/players/player-card-short.html'
...
class PlayerCardIndicators(PlayerCard):
    template_name = 'hockeyapp/v1/players/player-card-indicators.html'


class PlayerCardClubs(PlayerCard):
    template_name = 'hockeyapp/v1/players/player-card-clubs.html'
...
class PlayerCardCoaches(PlayerCard):
    template_name = 'hockeyapp/v1/players/player-card-coaches.html'
...
class PlayerCardPartners(PlayerCard):
    template_name = 'hockeyapp/v1/players/player-card-partners.html'


class PlayerCardPhotos(PlayerCard):
    template_name = 'hockeyapp/v1/players/player-card-photos.html'


class PlayerCardCommunication(PlayerCard):
    template_name = 'hockeyapp/v1/players/player-card-communication.html'


class PlayerCardNews(PlayerCard):
    template_name = 'hockeyapp/v1/players/player-card-news.html'


class PlayerCardNumbers(PlayerCard):
    template_name = 'hockeyapp/v1/players/player-card-numbers.html'
